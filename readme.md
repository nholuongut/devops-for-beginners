...
## DevOps Tools - Docker, Kubernetes, Azure Devops, Jenkins, Terraform, and Ansible. 3 Different Clouds - AWS, Azure and Google Cloud. 

## Introduction

> Do you need more reasons for enrolling for this amazing Demos on DevOps?
...
Are you ready to pratices DevOps with Docker, Kubernetes, Terraform, Ansible, Jenkins and Azure Devops in multiple clouds - AWS, Azure and Google Cloud?
Do you want to join 300,000+ praticesers having Amazing pratices Experiences with in28Minutes?
Buckle up and Get ready for this wonderful ride on DevOps, Microservices and the Cloud.
Look No Further!

## Demos Overview

DevOps is all about People, Process and Tools. In this Demos, you will understand the basics of DevOps and pratices to do DevOps with Docker, Kubernetes, Ansible, Terraform, Azure DevOps and Jenkins. You will pratices to implement DevOps with Continuous Integration, Continuous Delivery and Infrastructure as Code. You will play with 3 different clouds - AWS, Azure and Google Cloud.
...
You will pratices the basics of Kubernetes on the Google Kubernetes Engine implementing Service Discovery, Centralized Configuration and Load Balancing for Microservices. You will do DevOps with Kubernetes using Terraform (Infrastructure as Code) and Azure DevOps (Continuous Delivery) on multiple cloud platforms (AWS and Azure)

You will pratices the basics of Continuous Integration and Continuous Delivery and implement them using Jenkins and Azure DevOps. You will pratices to Create Kubernetes Clusters and Deploy Microservices to Kubernetes using Azure DevOps Pipelines on the Cloud with AWS EKS and Azure AKS.

You will pratices the basics of Terraform and Ansible and implement Infrastructure as Code. You will provision a number of AWS Resources - EC2 Instances and Load Balancers - using Terraform and configure them with Ansible. You will pratices to provision Kubernetes Clusters in AWS and Azure using Terraform. You would pratices to run Terraform Configuration in Azure DevOps Pipelines.

This Demos would be a perfect first step as an introduction to DevOps.


## What you'll pratices
- You will pratices DevOps with Docker, Kubernetes and Azure DevOps from ZERO, no previous experience required
- You will pratices the fundamentals of 6 Most Popular DevOps Tools - Docker, Kubernetes, Azure Devops, Jenkins, Terraform, and Ansible
- You will pratices the building blocks of DevOps - Continuous Integration, Continuous Delivery and Infrastructure as Code
- You will pratices to implement Azure Devops Pipelines integrating Docker, Kubernetes and  Terraform on AWS EKS and Azure AKS
- You will pratices DevOps with Continuous Integration & Continuous Delivery on Azure DevOps and Jenkins
...
## Requirements
- You have an attitude to pratices while having fun :)
...
- Step 09 - pratices Docker Images - Commands
- Step 10 - pratices Docker Containers - Commands
- Step 11 - pratices Docker Commands - system and stats
...
- Step 18 - Creating Terraform Project for pratices Terraform Maps
...
- Demos Promotion
  ...
  - Create YouTube Demos Preview Video
    - Add YouTube Demos Preview Video as End Video for all videos
